...
const CARDS_TABLE_TEXT = {
    ...
    featureDescription:
        'Все инструменты для DnD в одном месте — персонажи, инвентарь, заклинания и дайсы.',
...
const TOOL_CARDS = [
    {
        title: 'Дайсы',
        description:
            'Все кубы DnD: d2, d4, d6, d8, d10, d12, d20, d100. Быстрые броски для боёв, кампаний и онлайн-сессий.',
        link: '/dice'
    },
    {
